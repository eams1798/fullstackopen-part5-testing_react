...
Cypress.Commands.add('requestBackend', function ( path: string, method: string, body?: object, needAuth?: boolean ) {
...
Cypress.Commands.add('createTestingUser', function ( data: {
  name: string,
  username: string,
  password: string
}) {
