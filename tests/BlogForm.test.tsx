...
describe("Tests for BlogForm component", () => {
  ...
  test("BlogForm compoment calls setBlogs with the details of the new blog on submit", () => {
    const titleField = blogForm.container.querySelector("input#title") || new Element();
    const authorField = blogForm.container.querySelector("input#author") || new Element();
    const urlField = blogForm.container.querySelector("input#url") || new Element();
    const likesField = blogForm.container.querySelector("input#likes") || new Element();
